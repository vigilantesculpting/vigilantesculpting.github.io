  ...
  $.fn.lightbox = function () {
    this.each(function () {
      ...
      function lightboxOverlay() {
        ...
        $('.lightbox-overlay').fadeTo(0, 0.75);
      ...
      function lightboxLoading() {
        ...
        $('.lightbox-overlay, .lightbox-loading').click(function () {
          $('.lightbox-loading, .lightbox-overlay, .lightbox').fadeTo(0, 0, function () {
      ...
      function lightboxOpen() {
        ...
        $('.lightbox img').load(function () {
          ...
          $('.lightbox').css({
            ...
            $('.lightbox-title, .lightbox-nav, .lightbox img').fadeTo(0, 1);
          });
          ...
          $('#close').click(function () {
            ...
            $('.lightbox-overlay').delay(0).fadeTo(0, 0, function () {
