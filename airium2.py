...
class Airium:
    ...
    def get_tag_(self, tag_name: str) -> Type['Tag']:
        ...
        tag_name = doc.TAG_NAME_SUBSTITUTES.get(tag_name, tag_name)  # e.g. 'del'
        ...
        if tag_name.strip() in doc.SINGLE_TAGS:
            ...
            class SingleTag(Tag):
                ...
                ATTRIBUTE_NAME_SUBSTITUTES = doc.ATTRIBUTE_NAME_SUBSTITUTES
                ATTRIBUTE_VALUE_SUBSTITUTES = doc.ATTRIBUTE_VALUE_SUBSTITUTES
